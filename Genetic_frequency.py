/*This code computes the frequency of different amino acid codons for different gene sequences*/
/*Author: Sridevi S, Assistant Professor, Presidency University, Bangalore*/
